...
export class VoiceService {
    ...
    private setupSocketListeners() {
        socketService.on('voice-data', (data: { userId: string, audio: Int16Array }) => {
    ...
    private playAudioChunk(int16Data: Int16Array | ArrayBuffer, isLocalTest = false) {
        if (!this.audioContext) return;

        // Ensure we handle ArrayBuffers if they come from the network that way
        const data = int16Data instanceof Int16Array ? int16Data : new Int16Array(int16Data);
