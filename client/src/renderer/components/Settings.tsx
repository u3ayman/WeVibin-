        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ color: '#a1a1aa' }}>
                Configure your audio and controls
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                <label style={{ fontSize: '14px', color: '#a1a1aa' }}>
                  Input Volume (Gain)
                </label>
                <span
                  style={{
            ...
            >
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    handleAudioProcessingChange('echo', e.target.checked)
                  }
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    handleAudioProcessingChange('noise', e.target.checked)
                  }
                  style={{ width: '20px', height: '20px', cursor: 'pointer' }}
                />
                <div>
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    handleAudioProcessingChange('gain', e.target.checked)
                  }
                  style={{ width: '20px', height: '20px', cursor: 'pointer' }}
                />
                <div>
          ...
          >
            ...
            <div>
              ...
              <p
                style={{ fontSize: '12px', color: '#a1a1aa', marginTop: '8px' }}
              >
                Click &quot;Change Key&quot; and press any key to set as
                Push-to-Talk
              </p>
            </div>
          </motion.div>
