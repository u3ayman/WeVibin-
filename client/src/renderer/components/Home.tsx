...
export function Home({
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Crystal clear voice communication while vibing to your favorite tracks',
    ...
    <div className="wv-page">
      <div className="wv-container">
        <motion.div
          ...
          style={{ textAlign: 'center', padding: '44px 0 26px' }}
        >
          <motion.h1
            style={{
              fontSize: '48px',
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="wv-card"
                  style={{ padding: '18px', transition: 'all 0.2s' }}
                >
                  <div
                    style={{
                      width: '56px',
                      height: '56px',
                      borderRadius: '12px',
                      background: `linear-gradient(135deg, ${feature.color.includes('a855f7') ? '#a855f7' : '#22d3ee'}, ${feature.color.includes('7c3aed') ? '#7c3aed' : '#a855f7'})`,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      marginBottom: '16px',
        ...
        <motion.div
          ...
          style={{
            ...
            padding: '22px',
            background:
              'linear-gradient(135deg, rgba(168,85,247,0.1), rgba(34,211,238,0.08))',
